...
<main>
    <header class="fixed flex top-5 items-center z-[9999] rounded-full w-5xl border-2 h-14 bg-basic border-[#333333] left-1/2 -translate-x-1/2 text-xl">
            ...
            <div class="flex space-x-6 absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
                <a href="#about" class="cursor-pointer text-[#adadad] rounded-full px-3 py-1 hover:text-[#EEEEEE] hover:bg-[#1e1d1d] leading-none"><p>{@html t("general.about")}</p></a>
                <a href="#projects" class="cursor-pointer text-[#adadad] rounded-full px-3 py-1 hover:text-[#EEEEEE] hover:bg-[#1e1d1d] leading-none"><p>{@html t("general.projects")}</p></a>
                <a href="/" class="cursor-not-allowed text-[#5d5d5d] rounded-full px-3 py-1 leading-none"><p>{@html t("general.blog")}</p></a>
            </div>
        ...
        <div class="top-0 min-h-screen flex flex-col relative">
            ...
            <div class="center mx-auto w-auto h-150 mt-20 text-center leading-normal">
                <div class="mt-75 mb-0 mx-auto w-max px-8 py-2 rounded-full bg-basic border-[#333333] border-2 bg-opacity-100 text-xl text-white z-10 relative flex items-center gap-3">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" /></svg><p class="m-0 p-0">
                        {@html t("intro.title")}
                    </p><svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7" /></svg>
                </div>
        ...
        <div class="center mx-auto w-auto h-350 text-center leading-normal overflow-hidden mt-25" id="about">
            <div class="mt-100 mb-0 pt-0 mx-auto w-max px-8 py-2 text-xl text-white z-10 relative flex items-center gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" /></svg><p class="m-0">
