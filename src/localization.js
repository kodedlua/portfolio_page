export const localization = {
    pl: {
        ...
        intro: {
            ...
            subtitle: "Buduję przyszłość,@<br>@ nie wymówki."
        },
        about: {
    ...
    en: {
        ...
        intro: {
            title: "Jakub Wojtczak",
            subtitle: "Building the future,@<br>@ no excuses."
        },
        about: {
        ...
        contact: {
            subtitle: "Have a question, idea, or job offer? Write to me!",
            description: "Here you can find me.",
            discordCopySuccess: "Copied to clipboard!"
        }
    }
};
